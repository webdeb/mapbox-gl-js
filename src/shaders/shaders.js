...
import collisionCircleFragTemp from './collision_circle_temp.fragment.glsl';
import collisionCircleVertTemp from './collision_circle_temp.vertex.glsl';
...
export const collisionCircleTemp = compile(collisionCircleFragTemp, collisionCircleVertTemp);
